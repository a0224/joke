...
public class JokeFragment extends Fragment implements PullAndRefreshListViewListener,OnScrollListener
{
            ...
            public void run()
            {
                ...
                else
                {
                    ...
                    if (list != null)
                    {
                        ...
                        {
                            GlobalApplication.dBHelper.clear(T_JokeInfo.class);
    ...
    private void initViews(View root){
        ...
        mListview.setPullAndRefreshListViewListener(JokeFragment.this);
        mListview.setAdapter(mAdapter);
        mListview.setOnScrollListener(JokeFragment.this);
    ...
    public void loadLocalData()
    {
        ...
        tmpList = GlobalApplication.dBHelper.query(T_JokeInfo.class, null, null, null);
    ...
    {
        return new JokeListAdapter(context, dataList);
    }

    public T_Result sendRequest(int pageNo)
    {
        return new JokeListRequest().getJokeList(Constants.OP_JOKE, pageNo);
    }
