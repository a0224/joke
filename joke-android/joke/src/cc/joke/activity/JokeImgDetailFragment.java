...
public class JokeImgDetailFragment extends Fragment
{
    // 当前视图
    private View view;

    // 产品对象
    private T_JokeImgInfo jokeInfo;
    ...
    public JokeImgDetailFragment(T_JokeImgInfo jokeInfo, TextView joke_top_title)
    {
