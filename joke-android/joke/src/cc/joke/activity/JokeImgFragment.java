...
import cc.joke.R;
import cc.joke.adapter.JokeImgListAdapter;
...
import cc.joke.http.JokeListRequest;
...
public class JokeImgFragment extends Fragment implements PullAndRefreshListViewListener,OnScrollListener
{
    private final String PREFERENCE_PAGE = "JokeFragment Preference";
    private final String PAGE_KEY = "JokeFragment Preference Page Key";
    private final String POSTION_INDEX_KEY = "JokeFragment Preference Postion Index Key";
    private final String POSTION_TOP_KEY = "JokeFragment Preference Postion Top Key";
            ...
            public void run()
            {
                ...
                else
                {
                    ...
                    if (list != null)
                    {
                        ...
                        {
                            GlobalApplication.dBHelper.clear(T_JokeImgInfo.class);
    ...
    private void initViews(View root){
        ...
        mListview.setPullAndRefreshListViewListener(JokeImgFragment.this);
        mListview.setAdapter(mAdapter);
        mListview.setOnScrollListener(JokeImgFragment.this);
    ...
    public void loadLocalData()
    {
        ...
        tmpList = GlobalApplication.dBHelper.query(T_JokeImgInfo.class, null, null, null);
    ...
    {
        return new JokeImgListAdapter(context, dataList);
    }

    public T_Result sendRequest(int pageNo)
    {
        return new JokeListRequest().getJokeImagList(Constants.OP_JOKE, pageNo);
    }
