...
import cc.joke.R;
import cc.joke.activity.JokeImgDetailActivity;
 ...
 * @author wanghao
 */
public class JokeImgListAdapter extends BaseAdapter
{

    private static int mPosition;

    private static List<T_JokeImgInfo> mList;

    private Context mContext;

    public JokeImgListAdapter(Context context, List<T_JokeImgInfo> list)
    {
        this.mList = list;
    ...
    public static T_JokeImgInfo getCurItem()
    {
    ...
    {
        final T_JokeImgInfo obj = this.mList.get(position);
        ...
        viewHolder.mItemView.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                mPosition = position;
                Intent intent = new Intent(mContext, JokeImgDetailActivity.class);
    ...
    public void doCommitPraise(final T_JokeImgInfo obj, final int type, final CommitPraiseListener listener)
    {
