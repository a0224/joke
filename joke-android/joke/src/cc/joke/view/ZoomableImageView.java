...
import cc.joke.activity.OnImageTouchedListener;
...
public class ZoomableImageView extends View
{
    ...
    // the full 3 megapixel image, rather than the current 1024x768, this
    // should be changed down to
    // 200%.
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if (mBitmap != null && !mBitmap.isRecycled())
        {
            ...
            // If the current version is above Gingerbread and the layer type
            // is
