...
import cc.joke.R;
import cc.joke.adapter.HeadlinesListAdapter;
...
import cc.joke.http.HeadlinesListRequest;
...
public class HeadlinesFragment extends Fragment implements PullAndRefreshListViewListener, OnScrollListener
{
    private final String PREFERENCE_PAGE = "HeadlinesFragment Preference";

    private final String PAGE_KEY = "HeadlinesFragment Preference Page Key";

    private final String POSTION_INDEX_KEY = "HeadlinesFragment Preference Postion Index Key";

    private final String POSTION_TOP_KEY = "HeadlinesFragment Preference Postion Top Key";
            ...
            public void run()
            {
                ...
                else
                {
                    ...
                    if (list != null)
                    {
                        ...
                        {
                            GlobalApplication.dBHelper.clear(T_Headlines.class);
    ...
    private void initViews(View root)
    {
        ...
        mListview.setPullAndRefreshListViewListener(HeadlinesFragment.this);
        mListview.setAdapter(mAdapter);
        mListview.setOnScrollListener(HeadlinesFragment.this);
    ...
    public void loadLocalData()
    {
        ...
        tmpList = GlobalApplication.dBHelper.query(T_Headlines.class, null, null, null);
    ...
    {
        return new HeadlinesListAdapter(context, dataList);
    }

    public T_Result sendRequest(int pageNo)
    {
        return new HeadlinesListRequest().getHeadlinesList(Constants.OP_HEADLINES_LIST, pageNo);
    }
