...
public class Baidu
{
    ...
    public String uploadImage(File file)
    {
        ...
        String object = "/image/" + GetDate.fileName() + prefix;
        String url = null;
        try
        {
    ...
    public void downloadImage(String url)
    {
        ...
        File destFile = new File(Constants.DOWNLOAD_IMAGE_DIR + "/" + fileName);
     ...
     * @see [类、类#方法、类#成员]
     */
    public String uploadJokeApk(File file)
    {
        BaiduBCS baiduBCS = initBaiduBCS();

        String object = "/update/" + file.getName();
        String url = null;
        try
        {
            putObjectByFile(baiduBCS, object, file);
     ...
     * @see [类、类#方法、类#成员]
     */
    public String uploadApk(File file)
    {
        BaiduBCS baiduBCS = initBaiduBCS();

        String object = "/apk/" + file.getName();
        Log.i("", "Publish --- object:" + object);
        String url = null;
        try
        {
            putObjectByFile(baiduBCS, object, file);
