...
public class SystemInfo
{
    ...
    {
        TelephonyManager tm = (TelephonyManager) GlobalApplication.context.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    private int getNetwork()
    {
        ...
        ConnectivityManager connectMgr = (ConnectivityManager) GlobalApplication.context.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    private String getDisplay()
    {
        ...
        WindowManager mWm = (WindowManager) GlobalApplication.context.getSystemService(Context.WINDOW_SERVICE);
    ...
    {
        WifiManager wifi = (WifiManager) GlobalApplication.context.getSystemService(Context.WIFI_SERVICE);
    ...
    private String getDeviceID()
    {
        if (deviceid == null)
        {
            ...
            sb.append(mac).append(imei).append(board).append(brand).append(abi).append(device).append(display).append(
                    id).append(mf).append(model).append(product).append(tags).append(type).append(user);
    ...
    public String toString()
    {
        ...
        return "channel: " + channel + "--imei: " + imei + "--imsi: " + imsi + "--os: " + os + "--province: "
                ...
                + "--network: " + network + "--vcode: " + vcode + "--vname: " + vname + "--mac: " + mac + "--board: "
