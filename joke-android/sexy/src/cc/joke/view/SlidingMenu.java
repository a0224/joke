...
public class SlidingMenu extends RelativeLayout
{
    ...
    private void init(Context context)
    {
        ...
        rightmenuWidth = Util.dip2px(180);
        leftmenuWidth = screenWidth / 3;
    ...
    {
        LayoutParams behindParams = new LayoutParams(leftmenuWidth, LayoutParams.FILL_PARENT);
    ...
    {
        LayoutParams behindParams = new LayoutParams(rightmenuWidth, LayoutParams.FILL_PARENT);
    ...
    public void setCanSliding(boolean left, boolean right)
    {
        canSlideLeft = left;
        canSlideRight = right;
        // canSlideLeft = false;//强制不显示MenuView
    }
