...
exports.createClient = function(dbconfig){
        cfg = dbconfig;
...
exports.safeQuery = function( sql ){
	    if (!connection || !connection.connection.writable) {
	    	connection = createClient();
	    }
	    console.log("safeQuery---"+connection.connection.writable);
	    return connection.query(sql);
	}



exports.QueryUtil = function( table ){
        // 查询对象
