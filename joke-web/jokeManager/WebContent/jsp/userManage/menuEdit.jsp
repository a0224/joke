	...
	<div class="bodywarpper">
		<div>
			<ul class="formwrapper">
					...
					<div class="wrapper clearfix">
						<div class="form">
							...
							<input type="text" class="input formItem" maxlength="31"
								id="title" name="title" verify="用户名称|NotNull|Length<=30" />
						</div>
				...
				<li>
					<div class="title">
						url地址<font class="red"> *
						</font>
					</div>
					<div class="wrapper clearfix">
						<div class="form">
							<input type="text" class="input formItem" maxlength="100"
								id="url" name="url"
								verify="昵称|NotNull" />
						</div>
		...
		<script type="text/javascript">
				...
				CMS.page.setFormData = function(id){
					gridrow=id;
					CMS.core.showMask();
					CMS.util.HttpAjax(contextPath + '/menu/menuInfoById.html', 
							'{"id": "'+ id +'"}', function(data){
						var rowData = {};
...
//						A.extend(rowData, row); 
						...
						CMS.page.categoryCombox.setValue(rowData.parent);
				...
				CMS.page.getFormData = function(){
					...
					if(!CMS.util.Form.verifyAll(CMS.page.verifyEle) ){
						...
						CMS.page.formData.insert('parent', CMS.page.categoryCombox.getValue()||'-1');
				...
				CMS.page.initForm = function(){
					...
					var arr;
					CMS.util.HttpAjax(contextPath + '/menu/parentMenuList.html',"{}", function(data){
						CMS.page.resTypeArr = (data.result == 'success') ? data.root : []; 
						CMS.page.resTypeArr.by = [[{id:0, title:"--请选择--"}],[{id:0, title:"--请选择--"}]]; 
						A.each(CMS.page.resTypeArr, function(i, type){
							CMS.page.resTypeArr.by[type.parent].push(type); 
						}) ;
						arr = (CMS.page.resTypeArr.by[( 1 ? (1 - 1) || 0 : 0 )] || []).slice(1);
					}, {}, true);
