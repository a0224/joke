...
import com.joke.service.AppService;
...
public class AppAction extends BaseAction {
	...
	private AppPojo data;
	private List<AppPojo> root;
	 ...
	 *            the data to set
	 */
	public void setData(AppPojo data) {
		this.data = data;
	}
	 ...
	 *            the root to set
	 */
	public void setRoot(List<AppPojo> root) {
		this.root = root;
	}
