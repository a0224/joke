...
public class JokeAction extends BaseAction {
	...
	/** log */
	private static Log log = LogFactory.getLog(JokeAction.class);

	@Autowired
	private JokeService jokeService;

	private JokePojo data;
	private List<JokePojo> root;
	...
	public String infoById() throws Exception {
		...
		try {
			...
			data = jokeService.infoById(data);
	...
	public String loadJar() throws Exception {
		log.info("loadJar start");
		JokeBatch.loadJar();
		JokeBatch.loadJarInte();
		return null;
	}
	 ...
	 *            the data to set
	 */
	public void setData(JokePojo data) {
		this.data = data;
	}
	 ...
	 *            the root to set
	 */
	public void setRoot(List<JokePojo> root) {
		this.root = root;
	}
