...
@Component
public class JarDao extends BaseDao {

	private static Log log = LogFactory.getLog(JarDao.class);
	...
	@SuppressWarnings("unchecked")
	public List<JarPojo> list(final JarPojo data) {
		return getHibernateTemplate().executeFind(new HibernateCallback() {
			public Object doInHibernate(Session session)
					throws HibernateException, SQLException {

				String sql = "select * from tb_jar j where 1=1  ";
